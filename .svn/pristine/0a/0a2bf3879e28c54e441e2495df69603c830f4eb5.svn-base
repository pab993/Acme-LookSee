...
public class CandidateService {
	...
	public Candidate reconstruct(CandidateForm candidateForm, BindingResult binding) {
		...
		comprobarUsuarioUnico(candidateForm.getUsername(), binding);
	...
	private boolean comprobarUsuarioUnico(String username, BindingResult binding) {
		...
		if (!result) {
			...
			codigos[0] = "candidate.username.unique";
			//			error = new FieldError("cadidateForm", "password", "candidate.paswword.mismatch");
			error = new FieldError("candidateForm", "username", username, false, codigos, null, "");
